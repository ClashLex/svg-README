...
ROWS = [
    ("host",),
    ("kv", "Now", "1st-yr B.Tech CSE, KMEA Engg. College"),
    ("kv", "Lead", "Head @ Google Developer Groups Campus"),
    ("kv", "Also", "Campus Mantri @ GeeksforGeeks"),
    ("kv", "Also", "Google Student Ambassador"),
    ("kv", "Member", "IEDC / TinkerHub / Research & Idea Cafe"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, Next.js, TypeScript, Three.js"),
    ("kv", "Backend", "Python, Node, Supabase"),
    ("kv", "Other", "WebGL/Canvas, MediaPipe, IoT/hardware"),
    ("gap",),
    ("sec", "Building"),
    ("bul", "SETU -- satellite imagery upsampling (ISRO)"),
    ("bul", "KARAKURA PROTOCOL -- multi-agent incident response"),
    ("bul", "REIATSU SYSTEM v3 -- AR gesture visualizer"),
    ("bul", "DigitalTwin OS -- industrial safety twin"),
]
...
parts.append(f'<text x="{W/2}" y="{TITLEBAR_H/2 + 4}" fill="{MUTED}" font-size="12" '
             f'text-anchor="middle">clashlex@github: ~$ neofetch</text>')
