...
# Bleach-tinged ramp: empty -> brightest reiatsu-blue.
PALETTE = ["#15151a", "#123a42", "#0f5c68", "#188f9e", "#3fc2d1", "#7fe3ee"]
...
""".strip()
    ...
    parts.append(f'<text x="{canvas_w/2}" y="{TITLEBAR_H/2 + 4}" fill="{MUTED}" font-size="12" '
                 f'text-anchor="middle">clashlex@github: ~/contributions --graph</text>')
